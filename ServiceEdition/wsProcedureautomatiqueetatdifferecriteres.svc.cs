...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsProcedureautomatiqueetatdifferecriteres" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsProcedureautomatiqueetatdifferecriteres.svc ou wsProcedureautomatiqueetatdifferecriteres.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsProcedureautomatiqueetatdifferecriteres : IwsProcedureautomatiqueetatdifferecriteres
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsProcedureautomatiqueetatdifferecriteresWSBLL clsProcedureautomatiqueetatdifferecriteresWSBLL = new clsProcedureautomatiqueetatdifferecriteresWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsProcedureautomatiqueetatdifferecriteres Objet)
    //    {
    ...
    //            DataSet = clsProcedureautomatiqueetatdifferecriteresWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
