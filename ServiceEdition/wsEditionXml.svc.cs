...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionXml" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionXml.svc ou wsEditionXml.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionXml : IwsEditionXml
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionXmlWSBLL clsEditionXmlWSBLL = new clsEditionXmlWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionXml Objet)
    //    {
    ...
    //            DataSet = clsEditionXmlWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
