...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionEtatOutilsSeurite" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionEtatOutilsSeurite.svc ou wsEditionEtatOutilsSeurite.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionEtatOutilsSeurite : IwsEditionEtatOutilsSeurite
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionEtatOutilsSeuriteWSBLL clsEditionEtatOutilsSeuriteWSBLL = new clsEditionEtatOutilsSeuriteWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionEtatOutilsSeurite Objet)
    //    {
    ...
    //            DataSet = clsEditionEtatOutilsSeuriteWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
