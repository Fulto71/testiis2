...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionEtatParamtreComptabilite" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionEtatParamtreComptabilite.svc ou wsEditionEtatParamtreComptabilite.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionEtatParamtreComptabilite : IwsEditionEtatParamtreComptabilite
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionEtatParamtreComptabiliteWSBLL clsEditionEtatParamtreComptabiliteWSBLL = new clsEditionEtatParamtreComptabiliteWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionEtatParamtreComptabilite Objet)
    //    {
    ...
    //            DataSet = clsEditionEtatParamtreComptabiliteWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
