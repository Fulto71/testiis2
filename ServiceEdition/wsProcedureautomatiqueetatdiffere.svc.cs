...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsProcedureautomatiqueetatdiffere" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsProcedureautomatiqueetatdiffere.svc ou wsProcedureautomatiqueetatdiffere.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsProcedureautomatiqueetatdiffere : IwsProcedureautomatiqueetatdiffere
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsProcedureautomatiqueetatdiffereWSBLL clsProcedureautomatiqueetatdiffereWSBLL = new clsProcedureautomatiqueetatdiffereWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsProcedureautomatiqueetatdiffere Objet)
    //    {
    ...
    //            DataSet = clsProcedureautomatiqueetatdiffereWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
