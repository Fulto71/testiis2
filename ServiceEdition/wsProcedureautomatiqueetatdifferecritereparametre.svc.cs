...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsProcedureautomatiqueetatdifferecritereparametre" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsProcedureautomatiqueetatdifferecritereparametre.svc ou wsProcedureautomatiqueetatdifferecritereparametre.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsProcedureautomatiqueetatdifferecritereparametre : IwsProcedureautomatiqueetatdifferecritereparametre
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsProcedureautomatiqueetatdifferecritereparametreWSBLL clsProcedureautomatiqueetatdifferecritereparametreWSBLL = new clsProcedureautomatiqueetatdifferecritereparametreWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsProcedureautomatiqueetatdifferecritereparametre Objet)
    //    {
    ...
    //            DataSet = clsProcedureautomatiqueetatdifferecritereparametreWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
