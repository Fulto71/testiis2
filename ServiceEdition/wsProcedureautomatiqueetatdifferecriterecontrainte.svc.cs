...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsProcedureautomatiqueetatdifferecriterecontrainte" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsProcedureautomatiqueetatdifferecriterecontrainte.svc ou wsProcedureautomatiqueetatdifferecriterecontrainte.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsProcedureautomatiqueetatdifferecriterecontrainte : IwsProcedureautomatiqueetatdifferecriterecontrainte
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsProcedureautomatiqueetatdifferecriterecontrainteWSBLL clsProcedureautomatiqueetatdifferecriterecontrainteWSBLL = new clsProcedureautomatiqueetatdifferecriterecontrainteWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsProcedureautomatiqueetatdifferecriterecontrainte Objet)
    //    {
    ...
    //            DataSet = clsProcedureautomatiqueetatdifferecriterecontrainteWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
