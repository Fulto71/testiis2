...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionoutilstypedeliste" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionoutilstypedeliste.svc ou wsEditionoutilstypedeliste.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionoutilstypedeliste : IwsEditionoutilstypedeliste
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionoutilstypedelisteWSBLL clsEditionoutilstypedelisteWSBLL = new clsEditionoutilstypedelisteWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionoutilstypedeliste Objet)
    //    {
    ...
    //            DataSet = clsEditionoutilstypedelisteWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
