...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionEtatTiers" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionEtatTiers.svc ou wsEditionEtatTiers.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsEditionEtatTiers : IwsEditionEtatTiers
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsEditionEtatTiersWSBLL clsEditionEtatTiersWSBLL = new clsEditionEtatTiersWSBLL();
        ...
        public string pvgInsertIntoDataSetListeEtat(clsEditionEtatTiers Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsEditionEtatTiers clsEditionEtatTiers = new ZenithWebServeur.BOJ.clsEditionEtatTiers();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsEditionEtatTiers clsEditionEtatTiersDTO in Objet)
                //{
                ...
                DataSet = clsEditionEtatTiersWSBLL.pvgInsertIntoDataSetListeEtat(clsDonnee, clsObjetEnvoi);
        ...
        ///<summary>Cette fonction permet de d'executer une requete SELECT dans la base de donnees </summary>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDataSetTiers(clsEditionEtatTiers Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //}
                DataSet = clsEditionEtatTiersWSBLL.pvgInsertIntoDataSetTiers(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    // json = JsonConvert.SerializeObject(DataSet, Formatting.Indented);
