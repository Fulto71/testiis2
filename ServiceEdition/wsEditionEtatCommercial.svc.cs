...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionEtatCommercial" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionEtatCommercial.svc ou wsEditionEtatCommercial.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionEtatCommercial : IwsEditionEtatCommercial
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionEtatCommercialWSBLL clsEditionEtatCommercialWSBLL = new clsEditionEtatCommercialWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionEtatCommercial Objet)
    //    {
    ...
    //            DataSet = clsEditionEtatCommercialWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
