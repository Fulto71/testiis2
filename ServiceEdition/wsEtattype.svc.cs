...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEtattype" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEtattype.svc ou wsEtattype.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsEtattype : IwsEtattype
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsEtattypeWSBLL clsEtattypeWSBLL = new clsEtattypeWSBLL();
        ...
        public string pvgChargerDansDataSetPourCombo(ZenithWebServeur.DTO.clsEtattype Objet)
        {
        ...
        clsObjetEnvoi.OE_PARAM = new string[] {  };
            ...
            try
            {
                ...
                DataSet = clsEtattypeWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
