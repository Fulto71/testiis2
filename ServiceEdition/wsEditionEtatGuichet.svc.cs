...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsEditionEtatGuichet : IwsEditionEtatGuichet
    {
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetBrouillardCaisse1(ZenithWebServeur.DTO.clsEditionEtatGuichet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetBilletage2(ZenithWebServeur.DTO.clsEditionEtatGuichet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            clsEditionEtatGuichet.AG_CODEAGENCE = Objet.AG_CODEAGENCE.ToString();
            clsEditionEtatGuichet.DATEDEBUT = Objet.DATEDEBUT.ToString();
            clsEditionEtatGuichet.DATEFIN = Objet.DATEDEBUT.ToString();
            clsEditionEtatGuichet.OP_CODEOPERATEUREDITION = Objet.OP_CODEOPERATEUREDITION.ToString();
            clsEditionEtatGuichet.PL_CODENUMCOMPTE1 = Objet.PL_CODENUMCOMPTE1.ToString();
            clsEditionEtatGuichet.PL_CODENUMCOMPTE2 = Objet.PL_CODENUMCOMPTE2.ToString();
            clsEditionEtatGuichet.TS_CODETYPESCHEMACOMPTABLE = Objet.TS_CODETYPESCHEMACOMPTABLE.ToString();
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetArreteCaisse(ZenithWebServeur.DTO.clsEditionEtatGuichet Objet)
        {
            ...
            clsEditionEtatGuichet.JO_CODEJOURNAL = "";
            clsEditionEtatGuichet.OP_CODEOPERATEUR = Objet.OP_CODEOPERATEUR.ToString();
            clsEditionEtatGuichet.TYPEETAT = "P";//Objet.TYPEETAT.ToString();
            clsEditionEtatGuichet.TYPERETOUR = Objet.TYPERETOUR.ToString();
            clsEditionEtatGuichet.TYPEECRAN = Objet.TYPEECRAN.ToString();
            clsEditionEtatGuichet.SUPPRIMERTABLEINTERMEDIAIRE = Objet.SUPPRIMERTABLEINTERMEDIAIRE.ToString();
            clsEditionEtatGuichet.CB_CODECOUPURE = "";


            try
            {
                clsDonnee.pvgConnectionBase();
                DataSet = clsEditionEtatGuichetWSBLL.pvgInsertIntoDatasetArreteCaisse(clsDonnee, clsEditionEtatGuichet, clsObjetEnvoi);
                clsEditionEtatGuichet.TYPEETAT = "BILLETAGE";
                DataSet1 = clsEditionEtatGuichetWSBLL.pvgInsertIntoDatasetArreteCaisse(clsDonnee, clsEditionEtatGuichet, clsObjetEnvoi);
                clsEditionEtatGuichet.TYPEETAT = "BILLETAGERECAPITULATIF";
                DataSet2 = clsEditionEtatGuichetWSBLL.pvgInsertIntoDatasetArreteCaisse(clsDonnee, clsEditionEtatGuichet, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0 && DataSet1.Tables[0].Rows.Count > 0 && DataSet2.Tables[0].Rows.Count > 0)
                {
                    // json = JsonConvert.SerializeObject(DataSet, Formatting.Indented);
                    string reportPath = "~/Etats/" + Objet.ET_DOSSIER;
                    string reportFileName = Objet.ET_NOMETAT;// "YTDVarianceCrossTab.rpt";
                    ...
                    string[] vppFichierSousEtat = new string[] { "ArreteC_Recapitulatif.rpt", "RecuCaisseBilletage_mini.rpt" };
                    DataSet[] vppDataSetSousEtat = new DataSet[] { DataSet1, DataSet2 };
