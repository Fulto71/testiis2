...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsEdition : IwsEdition
    {
        ...
        public string pvgInsertIntoDatasetZone(ZenithWebServeur.DTO.clsEdition Objet)
        {
        ...
        public string pvgChargerDansDataSetPourComboAgenceEdition(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetAgence(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            clsObjetEnvoi.OE_PARAM = new string[] { Objet.EX_EXERCICE, Objet.SO_CODESOCIETE, Objet.OP_CODEOPERATEUR };

            try
            {
                clsDonnee.pvgDemarrerTransaction();
                DataSet = clsEditionWSBLL.pvgInsertIntoDatasetAgence(clsDonnee, clsObjetEnvoi);
                 if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetExercice(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgInsertIntoDatasetPeriodicite(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public string pvgPeriodicite(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        public string pvgPeriodiciteDateDebutFin(ZenithWebServeur.DTO.clsEdition Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            //if (DataSet.Tables[0].Rows[0]["SL_RESULTAT"].ToString() == "FALSE") { json = JsonConvert.SerializeObject(DataSet, Formatting.Indented); return json; }
            //}
            clsObjetEnvoi.OE_PARAM = new string[] { Objet.EX_EXERCICE, Objet.MO_CODEMOIS, Objet.PE_CODEPERIODICITE };
