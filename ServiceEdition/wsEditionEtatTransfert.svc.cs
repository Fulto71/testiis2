...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsEditionEtatTransfert" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsEditionEtatTransfert.svc ou wsEditionEtatTransfert.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    //public partial class wsEditionEtatTransfert : IwsEditionEtatTransfert
    //{
    //    private clsDonnee _clsDonnee = new clsDonnee();
    //    private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
    //    private clsEditionEtatTransfertWSBLL clsEditionEtatTransfertWSBLL = new clsEditionEtatTransfertWSBLL();
    ...
    //    public string pvgChargerDansDataSet(ZenithWebServeur.DTO.clsEditionEtatTransfert Objet)
    //    {
    ...
    //            DataSet = clsEditionEtatTransfertWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
