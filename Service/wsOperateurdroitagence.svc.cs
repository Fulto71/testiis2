...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsOperateurdroitagence : IwsOperateurdroitagence
    {
        ...
        //AJOUT
        public string pvgAjouterdroit(List<clsOperateurdroitagence> Objet)
        {
            ...
            try
            {
                ...
                foreach (ZenithWebServeur.DTO.clsOperateurdroitagence clsOperateurdroitagenceDTO in Objet)
                {
        ...
        //MODIFICATION
        public string pvgModifier(clsOperateurdroitagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsOperateurdroitagence.AG_CODEAGENCE = Objet.AG_CODEAGENCE.ToString();
                //clsOperateurdroitagence.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                ////clsOperateurdroitagence.OP_CODEOPERATEUR = Objet.OP_CODEOPERATEUR.ToString();
                //clsOperateurdroitagence.PV_CODEPOINTVENTE = Objet.PV_CODEPOINTVENTE.ToString();
                //clsOperateurdroitagence.PV_RAISONSOCIAL = Objet.PV_RAISONSOCIAL.ToString();
                //clsOperateurdroitagence.PV_BOITEPOSTAL = Objet.PV_BOITEPOSTAL.ToString();
                //clsOperateurdroitagence.PV_ADRESSEGEOGRAPHIQUE = Objet.PV_ADRESSEGEOGRAPHIQUE.ToString();
                //clsOperateurdroitagence.PV_TELEPHONE = Objet.PV_TELEPHONE.ToString();
                //clsOperateurdroitagence.PV_FAX = Objet.PV_FAX.ToString();
                //clsOperateurdroitagence.PV_EMAIL = Objet.PV_EMAIL.ToString();
                //clsOperateurdroitagence.PV_POINTVENTECODE = Objet.PV_POINTVENTECODE.ToString();
                //clsOperateurdroitagence.PV_NUMEROCOMPTE = Objet.PV_NUMEROCOMPTE.ToString();
                //clsOperateurdroitagence.PV_REFERENCE = Objet.PV_REFERENCE.ToString();
                //clsOperateurdroitagence.PV_DATECREATION = DateTime.Parse(Objet.PV_DATECREATION.ToString());
                //clsOperateurdroitagence.PV_ACTIF = Objet.PV_ACTIF.ToString();
                //clsOperateurdroitagence.OP_GERANT = Objet.OP_GERANT.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsOperateurdroitagenceWSBLL.pvgModifier(clsDonnee, clsOperateurdroitagence, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsOperateurdroitagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsOperateurdroitagenceWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsOperateurdroitagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
