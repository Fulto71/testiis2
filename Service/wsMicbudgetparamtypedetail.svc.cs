...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsMicbudgetparamtypedetail : IwsMicbudgetparamtypedetail
    {
        ...
        //AJOUT
        public string pvgAjouter(clsMicbudgetparamtypedetail Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicbudgetparamtypedetail clsMicbudgetparamtypedetail = new ZenithWebServeur.BOJ.clsMicbudgetparamtypedetail();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicbudgetparamtypedetail clsMicbudgetparamtypedetailDTO in Objet)
                //{

                clsMicbudgetparamtypedetail.BT_CODETYPEBUDGET = Objet.BT_CODETYPEBUDGET;
                clsMicbudgetparamtypedetail.BD_LIBELLE = Objet.BD_LIBELLE;

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparamtypedetailWSBLL.pvgAjouter(clsDonnee, clsMicbudgetparamtypedetail, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsMicbudgetparamtypedetail Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.BD_CODETYPEBUDGETDETAIL };

                //foreach (ZenithWebServeur.DTO.clsMicbudgetparamtypedetail clsMicbudgetparamtypedetailDTO in Objet)
                //{

                clsMicbudgetparamtypedetail.BT_CODETYPEBUDGET = Objet.BT_CODETYPEBUDGET;
                clsMicbudgetparamtypedetail.BD_CODETYPEBUDGETDETAIL = Objet.BD_CODETYPEBUDGETDETAIL;
                clsMicbudgetparamtypedetail.BD_LIBELLE = Objet.BD_LIBELLE;

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparamtypedetailWSBLL.pvgModifier(clsDonnee, clsMicbudgetparamtypedetail, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMicbudgetparamtypedetail Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.BT_CODETYPEBUDGET, Objet.BD_CODETYPEBUDGETDETAIL };
                ...
                clsObjetRetour.SetValue(true, clsMicbudgetparamtypedetailWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMicbudgetparamtypedetail Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.BT_CODETYPEBUDGET };
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMicbudgetparamtypedetail Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicbudgetparamtypedetailWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
