...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsMicbudgetparampostebudgetaire : IwsMicbudgetparampostebudgetaire
    {
        ...
        //AJOUT
        public string pvgAjouter(clsMicbudgetparampostebudgetaire Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire clsMicbudgetparampostebudgetaire = new ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicbudgetparampostebudgetaire clsMicbudgetparampostebudgetaireDTO in Objet)
                //{
                
                clsMicbudgetparampostebudgetaire.BT_CODETYPEBUDGET = Objet.BT_CODETYPEBUDGET.ToString();
                clsMicbudgetparampostebudgetaire.BD_CODETYPEBUDGETDETAIL = Objet.BD_CODETYPEBUDGETDETAIL.ToString();
                clsMicbudgetparampostebudgetaire.BN_CODENATUREPOSTEBUDGETAIRE = Objet.BN_CODENATUREPOSTEBUDGETAIRE.ToString();
                clsMicbudgetparampostebudgetaire.BG_LIBELLE = Objet.BG_LIBELLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgAjouter(clsDonnee, clsMicbudgetparampostebudgetaire, clsObjetEnvoi));
        ...
        //AJOUT
        public string pvgAjouterListePosteBudgetaireService(List<clsMicbudgetparampostebudgetaire> Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            ZenithWebServeur.BOJ.clsObjetEnvoi clsObjetEnvoi = new ZenithWebServeur.BOJ.clsObjetEnvoi();
            List<ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire> clsMicbudgetparampostebudgetaires = new List<ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire>();
            clsObjetEnvoi.OE_D = ConfigurationManager.AppSettings["OE_D"];
            clsObjetEnvoi.OE_X = ConfigurationManager.AppSettings["OE_X"];
            clsDonnee.vogCleCryptage = clsObjetEnvoi.OE_D;
            clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
            ...
            {
                //--TEST DES CHAMPS OBLIGATOIRES
                DataSet = TestChampObligatoireInsertpvgAjouterListePosteBudgetaireService(Objet[Idx]);
            //--VERIFICATION DU RESULTAT DU TEST
            if (DataSet.Tables[0].Rows[0]["SL_RESULTAT"].ToString() == "FALSE") { json = JsonConvert.SerializeObject(DataSet, Formatting.Indented); return json; }
            //--TEST DES TYPES DE DONNEES
        ...
        ZenithWebServeur.DTO.clsObjetRetour clsObjetRetour = new ZenithWebServeur.DTO.clsObjetRetour();
            try
            {
                ...
                foreach (ZenithWebServeur.DTO.clsMicbudgetparampostebudgetaire clsMicbudgetparampostebudgetaireDTO in Objet)
                {
                    clsObjetEnvoi.OE_PARAM = new string[] { clsMicbudgetparampostebudgetaireDTO.BG_CODEPOSTEBUDGETAIRE.ToString() };
                    ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire clsMicbudgetparampostebudgetaire = new ZenithWebServeur.BOJ.clsMicbudgetparampostebudgetaire();
                ...
                clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgAjouterListePosteBudgetaireService(clsDonnee, clsMicbudgetparampostebudgetaires, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //MODIFICATION
        public string pvgModifier(clsMicbudgetparampostebudgetaire Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsMicbudgetparampostebudgetaire.BG_CODEPOSTEBUDGETAIRE = Objet.BG_CODEPOSTEBUDGETAIRE.ToString();
                clsMicbudgetparampostebudgetaire.BT_CODETYPEBUDGET = Objet.BT_CODETYPEBUDGET.ToString();
                clsMicbudgetparampostebudgetaire.BD_CODETYPEBUDGETDETAIL = Objet.BD_CODETYPEBUDGETDETAIL.ToString();
                clsMicbudgetparampostebudgetaire.BN_CODENATUREPOSTEBUDGETAIRE = Objet.BN_CODENATUREPOSTEBUDGETAIRE.ToString();
                clsMicbudgetparampostebudgetaire.SR_CODESERVICE = Objet.SR_CODESERVICE.ToString();
                clsMicbudgetparampostebudgetaire.BG_LIBELLE = Objet.BG_LIBELLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgModifier(clsDonnee, clsMicbudgetparampostebudgetaire, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMicbudgetparampostebudgetaire Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMicbudgetparampostebudgetaire Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgChargerDansDataSetPosteBudgetaireService(clsMicbudgetparampostebudgetaire Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicbudgetparampostebudgetaireWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicbudgetparampostebudgetaireWSBLL.pvgChargerDansDataSetPosteBudgetaireService(clsDonnee, clsObjetEnvoi);
                 if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
