...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsProfession : IwsProfession
    {
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsProfession Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsProfession clsProfession = new ZenithWebServeur.BOJ.clsProfession();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsProfession clsProfessionDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsProfessionWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
