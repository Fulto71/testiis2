...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsActivite : IwsActivite
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsActivite Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsActivite clsActivite = new ZenithWebServeur.BOJ.clsActivite();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsActivite clsActiviteDTO in Objet)
                //{
        ...
        //COMBO
        public string pvgChargerDansDataSet1(clsActivite Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                DataSet = clsActiviteWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi);
                 if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
