...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsOptionAffichage" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsOptionAffichage.svc ou wsOptionAffichage.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsOptionAffichage : IwsOptionAffichage
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsOptionAffichage Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsOptionAffichage clsOptionAffichage = new ZenithWebServeur.BOJ.clsOptionAffichage();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsOptionAffichage clsOptionAffichageDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "OA_CODEOPTION", "OA_LIBELLE" };
                ...
                //DataSet = clsOptionAffichageWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
