...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsService : IwsService
    {
        ...
        //AJOUT
        public string pvgAjouter(clsService Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsService clsService = new ZenithWebServeur.BOJ.clsService();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.SR_LIBELLE };

                //foreach (ZenithWebServeur.DTO.clsService clsServiceDTO in Objet)
                //{

                clsService.SR_CODESERVICE = Objet.SR_CODESERVICE.ToString();
                clsService.SR_LIBELLE = Objet.SR_LIBELLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsServiceWSBLL.pvgAjouter(clsDonnee, clsService, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsService Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.SR_CODESERVICE };
                ...
                clsObjetRetour.SetValue(true, clsServiceWSBLL.pvgModifier(clsDonnee, clsService, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsService Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsServiceWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsService Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsService Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsServiceWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
