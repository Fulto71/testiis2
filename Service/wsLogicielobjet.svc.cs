...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsLogicielobjet : IwsLogicielobjet
    {
        ...
        //AJOUT
        public string pvgAjouter(clsLogicielobjet Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsLogicielobjet clsLogicielobjet = new ZenithWebServeur.BOJ.clsLogicielobjet();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsLogicielobjet clsLogicielobjetDTO in Objet)
                //{

                //clsLogicielobjet.AG_CODEAGENCE = Objet.AG_CODEAGENCE.ToString();
                //clsLogicielobjet.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                ////clsLogicielobjet.OP_CODEOPERATEUR = Objet.OP_CODEOPERATEUR.ToString();
                //clsLogicielobjet.PV_CODEPOINTVENTE = Objet.PV_CODEPOINTVENTE.ToString();
                //clsLogicielobjet.PV_RAISONSOCIAL = Objet.PV_RAISONSOCIAL.ToString();
                //clsLogicielobjet.PV_BOITEPOSTAL = Objet.PV_BOITEPOSTAL.ToString();
                //clsLogicielobjet.PV_ADRESSEGEOGRAPHIQUE = Objet.PV_ADRESSEGEOGRAPHIQUE.ToString();
                //clsLogicielobjet.PV_TELEPHONE = Objet.PV_TELEPHONE.ToString();
                //clsLogicielobjet.PV_FAX = Objet.PV_FAX.ToString();
                //clsLogicielobjet.PV_EMAIL = Objet.PV_EMAIL.ToString();
                //clsLogicielobjet.PV_POINTVENTECODE = Objet.PV_POINTVENTECODE.ToString();
                //clsLogicielobjet.PV_NUMEROCOMPTE = Objet.PV_NUMEROCOMPTE.ToString();
                //clsLogicielobjet.PV_REFERENCE = Objet.PV_REFERENCE.ToString();
                //clsLogicielobjet.PV_DATECREATION = DateTime.Parse(Objet.PV_DATECREATION.ToString());
                //clsLogicielobjet.PV_ACTIF = Objet.PV_ACTIF.ToString();
                //clsLogicielobjet.OP_GERANT = Objet.OP_GERANT.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsLogicielobjetWSBLL.pvgAjouter(clsDonnee, clsLogicielobjet, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsLogicielobjet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsLogicielobjetWSBLL.pvgModifier(clsDonnee, clsLogicielobjet, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsLogicielobjet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsLogicielobjetWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsLogicielobjet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsLogicielobjetWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsLogicielobjet Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                if (Objet.OT_CODETYPEOBJET == "5")
                    clsObjetEnvoi.OE_PARAM = new string[] { Objet.OT_CODETYPEOBJET, Objet.LO_CODELOGICIEL };

                if (Objet.OT_CODETYPEOBJET == "2")
                    clsObjetEnvoi.OE_PARAM = new string[] { Objet.OT_CODETYPEOBJET, Objet.LO_CODELOGICIEL, Objet.OB_RATTACHEA };
