...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsRaisondepart" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsRaisondepart.svc ou wsRaisondepart.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsRaisondepart : IwsRaisondepart
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsRaisondepartWSBLL clsRaisondepartWSBLL = new clsRaisondepartWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsRaisondepart Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsRaisondepart clsRaisondepart = new ZenithWebServeur.BOJ.clsRaisondepart();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsRaisondepart clsRaisondepartDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsRaisondepartWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsRaisondepartWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
