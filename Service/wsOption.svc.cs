...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsOption : IwsOption
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsOption Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsOption clsOption = new ZenithWebServeur.BOJ.clsOption();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsOption clsOptionDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "O_CODEOPTION", "O_LIBELLE" };
                DataSet.Tables.Add("TABLE");
                for (int i = 0; i < vlpChamp1.Length; i++)
                {
                    DataSet.Tables[0].Columns.Add(vlpChamp1[i]);
                }
                DataSet.Tables[0].Rows.Add("Tous les comptes", "Tous les comptes");
                DataSet.Tables[0].Rows.Add("Comptes mouvementés", "Comptes mouvementés");
                DataSet.Tables[0].Rows.Add("Comptes individuels", "Comptes individuels");
                DataSet.Tables[0].Rows.Add("Comptes collectifs", "Comptes collectifs");
                DataSet.Tables[0].Rows.Add("Comptes individuels mouvementés", "Comptes individuels mouvementés");

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;
                
                //DataSet = clsOptionWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
