...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsTypecontrat" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsTypecontrat.svc ou wsTypecontrat.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsTypecontrat : IwsTypecontrat
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsTypecontratWSBLL clsTypecontratWSBLL = new clsTypecontratWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsTypecontrat Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsTypecontrat clsTypecontrat = new ZenithWebServeur.BOJ.clsTypecontrat();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsTypecontrat clsTypecontratDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsTypecontratWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsTypecontratWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
