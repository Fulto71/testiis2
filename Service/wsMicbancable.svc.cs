...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicbancable" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicbancable.svc ou wsMicbancable.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicbancable : IwsMicbancable
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicbancableWSBLL clsMicbancableWSBLL = new clsMicbancableWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMicbancable Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicbancable clsMicbancable = new ZenithWebServeur.BOJ.clsMicbancable();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicbancable clsMicbancableDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMicbancableWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicbancableWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
