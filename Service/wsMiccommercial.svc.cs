...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMiccommercial" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMiccommercial.svc ou wsMiccommercial.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMiccommercial : IwsMiccommercial
    {
        ...
        //AJOUT
        public string pvgAjouter(clsMiccommercial Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMiccommercial clsMiccommercial = new ZenithWebServeur.BOJ.clsMiccommercial();
        ...
        //AJOUT
        public string pvgValeurScalaireRequeteCount(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.AG_CODEAGENCE, Objet.CM_CODECOMMERCIAL };

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgValeurScalaireRequeteCount(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //AJOUT
        public string pvgModifier1(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            //{
            //--TEST DES CHAMPS OBLIGATOIRES
            DataSet = TestChampObligatoireInsertpvgModifier1(Objet);
            //--VERIFICATION DU RESULTAT DU TEST
            if (DataSet.Tables[0].Rows[0]["SL_RESULTAT"].ToString() == "FALSE") { json = JsonConvert.SerializeObject(DataSet, Formatting.Indented); return json; }
            //--TEST DES TYPES DE DONNEES
            DataSet = TestTypeDonnee(Objet);
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgModifier1(clsDonnee, clsMiccommercial, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //AJOUT
        public string pvgGenererReleveCommission(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            //{
            //--TEST DES CHAMPS OBLIGATOIRES
            //DataSet = TestChampObligatoireInsertpvgGenererReleveCommission(Objet);
            ////--VERIFICATION DU RESULTAT DU TEST
            //if (DataSet.Tables[0].Rows[0]["SL_RESULTAT"].ToString() == "FALSE") { json = JsonConvert.SerializeObject(DataSet, Formatting.Indented); return json; }
            ////--TEST DES TYPES DE DONNEES
            //DataSet = TestTypeDonnee(Objet);
            ...
            try
            {
                ...
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] {
                    Objet.AG_CODEAGENCE, Objet.CM_IDCOMMERCIAL, Objet.CC_CODECOMMISSION, Objet.DATEDEBUT, Objet.DATEFIN, Objet.OP_CODEOPERATEUREDITION
                };
                ...
                /* clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgGenererReleveCommission(clsDonnee, clsObjetEnvoi));
                 if (clsObjetRetour.OR_BOOLEEN)
                 {
                     DataSet = new DataSet();
                     DataRow dr = dt.NewRow();
                ...
                DataSet = clsMiccommercialWSBLL.pvgGenererReleveCommission(clsDonnee, clsObjetEnvoi);
        ...
        //MODIFICATION
        public string pvgModifier(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccommercialWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
        ...
        //LISTE
        public string pvgChargerListeCommercialparNom(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.AG_CODEAGENCE, Objet.CM_CODECOMMERCIAL, Objet.CM_NOMCOMMERCIAL, Objet.CM_PRENOMCOMMERCIAL, Objet.CM_DATECREATION1, Objet.CM_DATECREATION2 };
                ...
                //clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccommercialWSBLL.pvgChargerListeCommercialparNom(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccommercialWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourComboCommerciauxTontine(clsMiccommercial Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMiccommercialWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccommercialWSBLL.pvgChargerDansDataSetPourComboCommerciauxTontine(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
