...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMiccommercialtype" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMiccommercialtype.svc ou wsMiccommercialtype.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMiccommercialtype : IwsMiccommercialtype
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMiccommercialtypeWSBLL clsMiccommercialtypeWSBLL = new clsMiccommercialtypeWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMiccommercialtype Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMiccommercialtype clsMiccommercialtype = new ZenithWebServeur.BOJ.clsMiccommercialtype();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMiccommercialtype clsMiccommercialtypeDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMiccommercialtypeWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccommercialtypeWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
