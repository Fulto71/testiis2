...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicaction" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicaction.svc ou wsMicaction.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicaction : IwsMicaction
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicactionWSBLL clsMicactionWSBLL = new clsMicactionWSBLL();
        ...
        //AJOUT
        public string pvgAjouter(clsMicaction Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicaction clsMicaction = new ZenithWebServeur.BOJ.clsMicaction();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicaction clsMicactionDTO in Objet)
                //{
                ...
                clsObjetRetour.SetValue(true, clsMicactionWSBLL.pvgAjouter(clsDonnee, clsMicaction, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsMicaction Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicactionWSBLL.pvgModifier(clsDonnee, clsMicaction, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMicaction Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicactionWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMicaction Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicactionWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicactionWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
