...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMictypepersonnel" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMictypepersonnel.svc ou wsMictypepersonnel.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMictypepersonnel : IwsMictypepersonnel
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMictypepersonnelWSBLL clsMictypepersonnelWSBLL = new clsMictypepersonnelWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMictypepersonnel Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMictypepersonnel clsMictypepersonnel = new ZenithWebServeur.BOJ.clsMictypepersonnel();
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.TM_CODEMEMBRE };

                //foreach (ZenithWebServeur.DTO.clsMictypepersonnel clsMictypepersonnelDTO in Objet)
                //{

                //clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                //clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMictypepersonnelWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMictypepersonnelWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
