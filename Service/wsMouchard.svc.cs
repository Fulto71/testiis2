...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMouchard" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMouchard.svc ou wsMouchard.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMouchard : IwsMouchard
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMouchardWSBLL clsMouchardWSBLL = new clsMouchardWSBLL();
        ...
        //AJOUT
        public string pvgAjouter(clsMouchard Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMouchard clsMouchard = new ZenithWebServeur.BOJ.clsMouchard();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMouchard clsMouchardDTO in Objet)
                //{

                clsMouchard.AG_CODEAGENCE = Objet.AG_CODEAGENCE.ToString();
             

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMouchardWSBLL.pvgAjouter(clsDonnee, clsMouchard, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsMouchard Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMouchardWSBLL.pvgModifier(clsDonnee, clsMouchard, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMouchard Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMouchardWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMouchard Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMouchardWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMouchardWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
