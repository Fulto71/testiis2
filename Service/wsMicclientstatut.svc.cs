...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicclientstatut" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicclientstatut.svc ou wsMicclientstatut.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicclientstatut : IwsMicclientstatut
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicclientstatutWSBLL clsMicclientstatutWSBLL = new clsMicclientstatutWSBLL();
        ...
        public string pvgChargerDansDataSetPourCombo(clsMicclientstatut Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicclientstatut clsMicclientstatut = new ZenithWebServeur.BOJ.clsMicclientstatut();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicclientstatut clsMicclientstatutDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                DataSet = clsMicclientstatutWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
