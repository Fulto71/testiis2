...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsPays : IwsPays
    {
        ...
        //MODIFICATION
        public string pvgModifier(clsPays Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsPays clsPays = new ZenithWebServeur.BOJ.clsPays();
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.PY_CODEPAYS };

                //foreach (ZenithWebServeur.DTO.clsPays clsPaysDTO in Objet)
                //{

                clsPays.PY_CODEPAYS = Objet.PY_CODEPAYS.ToString();
                clsPays.PY_CODEPOSTALE = Objet.PY_CODEPOSTALE.ToString();
                clsPays.DE_CODEDEVISE = Objet.DE_CODEDEVISE.ToString();
                clsPays.ZT_CODEZONE = Objet.ZT_CODEZONE.ToString();
                clsPays.PY_LIBELLE = Objet.PY_LIBELLE.ToString();
                clsPays.PY_LIBELLENATIONALITE = Objet.PY_LIBELLENATIONALITE.ToString();
                clsPays.PY_REFERENCE = Objet.PY_REFERENCE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsPaysWSBLL.pvgModifier(clsDonnee, clsPays, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsPays Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsPaysWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsPaysWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
        ...
        //COMBO PAYS
        public string pvgChargerDansDataSetPourCombo(clsPays Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        //COMBO NATIONNALITE
        public string pvgChargerDansDataSetPourComboNATIONALITE(clsPays Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsPaysWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsPaysWSBLL.pvgChargerDansDataSetPourComboNATIONALITE(clsDonnee, clsObjetEnvoi);
                 if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
