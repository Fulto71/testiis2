...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicordrevirementreseau" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicordrevirementreseau.svc ou wsMicordrevirementreseau.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicordrevirementreseau : IwsMicordrevirementreseau
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicordrevirementreseauWSBLL clsMicordrevirementreseauWSBLL = new clsMicordrevirementreseauWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMicordrevirementreseau Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicordrevirementreseau clsMicordrevirementreseau = new ZenithWebServeur.BOJ.clsMicordrevirementreseau();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicordrevirementreseau clsMicordrevirementreseauDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMicordrevirementreseauWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicordrevirementreseauWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
