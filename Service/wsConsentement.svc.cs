...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsConsentement" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsConsentement.svc ou wsConsentement.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsConsentement : IwsConsentement
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsConsentement Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsConsentement clsConsentement = new ZenithWebServeur.BOJ.clsConsentement();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsConsentement clsConsentementDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "CR_CONSENTEMENT", "CR_LIBELLE" };
                ...
                //DataSet = clsConsentementWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
