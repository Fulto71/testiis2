...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsTarificationzone" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsTarificationzone.svc ou wsTarificationzone.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsTarificationzone : IwsTarificationzone
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsTarificationzoneWSBLL clsTarificationzoneWSBLL = new clsTarificationzoneWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsTarificationzone Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsTarificationzone clsTarificationzone = new ZenithWebServeur.BOJ.clsTarificationzone();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsTarificationzone clsTarificationzoneDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsTarificationzoneWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsTarificationzoneWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
