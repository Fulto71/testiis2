...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsFormejuridique" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsFormejuridique.svc ou wsFormejuridique.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsFormejuridique : IwsFormejuridique
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsFormejuridiqueWSBLL clsFormejuridiqueWSBLL = new clsFormejuridiqueWSBLL();
        ...
        //COMBO FORME JURIDIQUE
        public string pvgChargerDansDataSetPourCombo(clsFormejuridique Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsFormejuridique clsFormejuridique = new ZenithWebServeur.BOJ.clsFormejuridique();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsFormejuridique clsFormejuridiqueDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsFormejuridiqueWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsFormejuridiqueWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
