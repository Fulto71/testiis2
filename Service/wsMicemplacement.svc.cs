...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicemplacement" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicemplacement.svc ou wsMicemplacement.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicemplacement : IwsMicemplacement
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicemplacementWSBLL clsMicemplacementWSBLL = new clsMicemplacementWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMicemplacement Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicemplacement clsMicemplacement = new ZenithWebServeur.BOJ.clsMicemplacement();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicemplacement clsMicemplacementDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMicemplacementWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicemplacementWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
