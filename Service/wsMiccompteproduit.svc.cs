...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMiccompteproduit" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMiccompteproduit.svc ou wsMiccompteproduit.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMiccompteproduit : IwsMiccompteproduit
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMiccompteproduitWSBLL clsMiccompteproduitWSBLL = new clsMiccompteproduitWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMiccompteproduit Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMiccompteproduit clsMiccompteproduit = new ZenithWebServeur.BOJ.clsMiccompteproduit();
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.PD_CODETYPEPRODUIT };

                //foreach (ZenithWebServeur.DTO.clsMiccompteproduit clsMiccompteproduitDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMiccompteproduitWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMiccompteproduitWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
