...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsProfil  : IwsProfil 
    {
        ...
        //AJOUT
        public string pvgAjouter(clsProfil Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsProfil clsProfil = new ZenithWebServeur.BOJ.clsProfil();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsProfil clsProfilDTO in Objet)
                //{

                clsProfil.PO_CODEPROFIL = Objet.PO_CODEPROFIL.ToString();
                clsProfil.PO_LIBELLE = Objet.PO_LIBELLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsProfilWSBLL.pvgAjouter(clsDonnee, clsProfil, clsObjetEnvoi));
        ...
        //AJOUT
        public string pvgMiseAJourTousLesOperateurLieProfil(clsProfil Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            //{
            //--TEST DES CHAMPS OBLIGATOIRES
            DataSet = TestChampObligatoireInsertpvgMiseAJourTousLesOperateurLieProfil(Objet);
            //--VERIFICATION DU RESULTAT DU TEST
            if (DataSet.Tables[0].Rows[0]["SL_RESULTAT"].ToString() == "FALSE") { json = JsonConvert.SerializeObject(DataSet, Formatting.Indented); return json; }
            //--TEST DES TYPES DE DONNEES
            DataSet = TestTypeDonnee(Objet);
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsProfilWSBLL.pvgMiseAJourTousLesOperateurLieProfil(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //MODIFICATION
        public string pvgModifier(clsProfil Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsProfilWSBLL.pvgModifier(clsDonnee, clsProfil, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsProfil Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsProfilWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsProfil Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsProfilWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsProfil Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
