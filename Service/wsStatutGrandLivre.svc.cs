...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsStatutGrandLivre : IwsStatutGrandLivre
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsStatutGrandLivre Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsStatutGrandLivre clsStatutGrandLivre = new ZenithWebServeur.BOJ.clsStatutGrandLivre();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsStatutGrandLivre clsStatutGrandLivreDTO in Objet)
                //{
                ...
                //DataSet = clsStatutGrandLivreWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
