...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicordrevirementsens" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicordrevirementsens.svc ou wsMicordrevirementsens.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicordrevirementsens : IwsMicordrevirementsens
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicordrevirementsensWSBLL clsMicordrevirementsensWSBLL = new clsMicordrevirementsensWSBLL();
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsMicordrevirementsens Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicordrevirementsens clsMicordrevirementsens = new ZenithWebServeur.BOJ.clsMicordrevirementsens();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicordrevirementsens clsMicordrevirementsensDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMicordrevirementsensWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicordrevirementsensWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
