...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsSexe : IwsSexe
    {
        ...
        //COMBO SEXE
        public string pvgChargerDansDataSetPourCombo(clsSexe Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsSexe clsSexe = new ZenithWebServeur.BOJ.clsSexe();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsSexe clsSexeDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsSexeWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //COMBO SEXE
        public string pvgChargerDansDataSetPourCombo1(clsSexe Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { "01#02" };
        ...
        //COMBO SEXE
        public string pvgChargerDansDataSetPourCombo_second(clsSexe Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
