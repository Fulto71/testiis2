...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsOperateurdroit : IwsOperateurdroit
    {
        ...
        //AJOUT
        public string pvgAjouterdroit(List<clsOperateurdroit> Objet)
        {
            ...
            List<ZenithWebServeur.BOJ.clsOperateurdroit> clsOperateurdroits = new List<ZenithWebServeur.BOJ.clsOperateurdroit>();
            ...
            try
            {
                ...
                foreach (ZenithWebServeur.DTO.clsOperateurdroit clsOperateurdroitDTO in Objet)
                {
                    //clsObjetEnvoi.OE_PARAM = new string[] { clsOperateurdroitDTO.PO_CODEPROFIL };
                    ZenithWebServeur.BOJ.clsOperateurdroit clsOperateurdroit = new ZenithWebServeur.BOJ.clsOperateurdroit();
                ...
                clsObjetRetour.SetValue(true, clsOperateurdroitWSBLL.pvgAjouterdroit(clsDonnee, clsOperateurdroits, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsOperateurdroit Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsOperateurdroit.AG_CODEAGENCE = Objet.AG_CODEAGENCE.ToString();
                //clsOperateurdroit.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                ////clsOperateurdroit.OP_CODEOPERATEUR = Objet.OP_CODEOPERATEUR.ToString();
                //clsOperateurdroit.PV_CODEPOINTVENTE = Objet.PV_CODEPOINTVENTE.ToString();
                //clsOperateurdroit.PV_RAISONSOCIAL = Objet.PV_RAISONSOCIAL.ToString();
                //clsOperateurdroit.PV_BOITEPOSTAL = Objet.PV_BOITEPOSTAL.ToString();
                //clsOperateurdroit.PV_ADRESSEGEOGRAPHIQUE = Objet.PV_ADRESSEGEOGRAPHIQUE.ToString();
                //clsOperateurdroit.PV_TELEPHONE = Objet.PV_TELEPHONE.ToString();
                //clsOperateurdroit.PV_FAX = Objet.PV_FAX.ToString();
                //clsOperateurdroit.PV_EMAIL = Objet.PV_EMAIL.ToString();
                //clsOperateurdroit.PV_POINTVENTECODE = Objet.PV_POINTVENTECODE.ToString();
                //clsOperateurdroit.PV_NUMEROCOMPTE = Objet.PV_NUMEROCOMPTE.ToString();
                //clsOperateurdroit.PV_REFERENCE = Objet.PV_REFERENCE.ToString();
                //clsOperateurdroit.PV_DATECREATION = DateTime.Parse(Objet.PV_DATECREATION.ToString());
                //clsOperateurdroit.PV_ACTIF = Objet.PV_ACTIF.ToString();
                //clsOperateurdroit.OP_GERANT = Objet.OP_GERANT.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsOperateurdroitWSBLL.pvgModifier(clsDonnee, clsOperateurdroit, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsOperateurdroit Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsOperateurdroitWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgInsertIntoDatasetGrille(clsOperateurdroit Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsOperateurdroitWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgInsertIntoDatasetGrille_second(clsOperateurdroit Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
