...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsMicbudgetparamtype : IwsMicbudgetparamtype
    {
        ...
        //AJOUT
        public string pvgAjouter(clsMicbudgetparamtype Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicbudgetparamtype clsMicbudgetparamtype = new ZenithWebServeur.BOJ.clsMicbudgetparamtype();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicbudgetparamtype clsMicbudgetparamtypeDTO in Objet)
                //{
                
                clsMicbudgetparamtype.BT_LIBELLE = Objet.BT_LIBELLE;

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparamtypeWSBLL.pvgAjouter(clsDonnee, clsMicbudgetparamtype, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsMicbudgetparamtype Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsMicbudgetparamtype.BT_CODETYPEBUDGET = Objet.BT_CODETYPEBUDGET;
                clsMicbudgetparamtype.BT_LIBELLE = Objet.BT_LIBELLE;

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMicbudgetparamtypeWSBLL.pvgModifier(clsDonnee, clsMicbudgetparamtype, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMicbudgetparamtype Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicbudgetparamtypeWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMicbudgetparamtype Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicbudgetparamtypeWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMicbudgetparamtype Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
