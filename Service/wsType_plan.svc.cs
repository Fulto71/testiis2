...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsType_plan" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsType_plan.svc ou wsType_plan.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsType_plan : IwsType_plan
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsType_planWSBLL clsType_planWSBLL = new clsType_planWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsType_plan Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsType_plan clsType_plan = new ZenithWebServeur.BOJ.clsType_plan();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsType_plan clsType_planDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsType_planWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsType_planWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
