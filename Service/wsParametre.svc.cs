...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsParametre : IwsParametre
    {
        ...
        //AJOUT
        public string pvgAjouter(clsParametre Objet)
        {
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsParametre clsParametreDTO in Objet)
                //{

                clsParametre.SO_CODESOCIETE = Objet.SO_CODESOCIETE.ToString();
                clsParametre.PP_CODEPARAMETRE = Objet.PP_CODEPARAMETRE.ToString();
                clsParametre.PP_LIBELLE = Objet.PP_LIBELLE.ToString();
                clsParametre.PP_BORNEMIN = Double.Parse(Objet.PP_BORNEMIN.ToString());
                clsParametre.PP_BORNEMAX = Double.Parse(Objet.PP_BORNEMAX.ToString());
                clsParametre.PP_MONTANTMINI = Double.Parse(Objet.PP_MONTANTMINI.ToString());
                clsParametre.PP_MONTANTMAXI = Double.Parse(Objet.PP_MONTANTMAXI.ToString());
                clsParametre.PP_TAUX = Decimal.Parse(Objet.PP_TAUX.ToString());
                clsParametre.PP_MONTANT = Double.Parse(Objet.PP_MONTANT.ToString());
                clsParametre.PP_VALEUR = Objet.PP_VALEUR.ToString();
                clsParametre.PL_CODENUMCOMPTE = Objet.PL_CODENUMCOMPTE.ToString();
                clsParametre.PP_AFFICHER = Objet.PP_AFFICHER.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsParametreWSBLL.pvgAjouter(clsDonnee, clsParametre, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsParametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.SO_CODESOCIETE, Objet.PP_CODEPARAMETRE };
                ...
                clsObjetRetour.SetValue(true, clsParametreWSBLL.pvgModifier(clsDonnee, clsParametre, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsParametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsParametreWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsParametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsParametreWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
