...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsJourferie" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsJourferie.svc ou wsJourferie.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsJourferie : IwsJourferie
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsJourferieWSBLL clsJourferieWSBLL = new clsJourferieWSBLL();
        ...
        //AJOUT
        public string pvgAjouter(clsJourferie Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsJourferie clsJourferie = new ZenithWebServeur.BOJ.clsJourferie();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsJourferie clsJourferieDTO in Objet)
                //{

                clsJourferie.FJ_JOUR = DateTime.Parse(Objet.FJ_JOUR.ToString());
                clsJourferie.FJ_LIBELLE = Objet.FJ_LIBELLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsJourferieWSBLL.pvgAjouter(clsDonnee, clsJourferie, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsJourferie Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.FJ_JOUR };
                ...
                clsObjetRetour.SetValue(true, clsJourferieWSBLL.pvgModifier(clsDonnee, clsJourferie, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsJourferie Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsJourferieWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsJourferie Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsJourferieWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsJourferieWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
