...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsBanque : IwsBanque
    {
        ...
        //AJOUT
        public string pvgAjouter(clsBanque Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsBanque clsBanque = new ZenithWebServeur.BOJ.clsBanque();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsBanque clsBanqueDTO in Objet)
                //{
                
                clsBanque.BQ_RAISONSOCIAL = Objet.BQ_RAISONSOCIAL.ToString();
                clsBanque.BQ_SIGLE = Objet.BQ_SIGLE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsBanqueWSBLL.pvgAjouter(clsDonnee, clsBanque, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsBanque Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsBanque.BQ_CODEBANQUE = Objet.BQ_CODEBANQUE.ToString();
                clsBanque.BQ_RAISONSOCIAL = Objet.BQ_RAISONSOCIAL.ToString();
                clsBanque.BQ_SIGLE = Objet.BQ_SIGLE.ToString();
                ...
                clsObjetRetour.SetValue(true, clsBanqueWSBLL.pvgModifier(clsDonnee, clsBanque, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsBanque Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsBanqueWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsBanque Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsBanqueWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsBanque Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
