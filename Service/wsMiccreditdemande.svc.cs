...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMiccreditdemande" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMiccreditdemande.svc ou wsMiccreditdemande.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMiccreditdemande : IwsMiccreditdemande
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMiccreditdemandeWSBLL clsMiccreditdemandeWSBLL = new clsMiccreditdemandeWSBLL();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMiccreditdemande Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMiccreditdemande clsMiccreditdemande = new ZenithWebServeur.BOJ.clsMiccreditdemande();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMiccreditdemande clsMiccreditdemandeDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMiccreditdemandeWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMiccreditdemande Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] {
                    Objet.AG_CODEAGENCE, Objet.CR_DATEMISEENPLACE1, Objet.CR_DATEMISEENPLACE2, Objet.CL_CODECLIENT, Objet.CL_NOMPRENOMCLIENT
                };
                ...
                DataSet = clsMiccreditdemandeWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
