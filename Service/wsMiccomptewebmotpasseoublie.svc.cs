...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsMiccomptewebmotpasseoublie : IwsMiccomptewebmotpasseoublie
    {
        ...
        public string pvgSelectDataSetUserForgotPassword(clsMiccomptewebmotpasseoublie Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMiccomptewebmotpasseoublie clsMiccomptewebmotpasseoublie = new ZenithWebServeur.BOJ.clsMiccomptewebmotpasseoublie();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMiccomptewebmotpasseoublie clsMiccomptewebmotpasseoublieDTO in Objet)
                //{
                ...
                clsObjetRetour.SetValue(true, clsMiccomptewebmotpasseoublieWSBLL.pvgSelectDataSetUserForgotPassword(clsDonnee, Objet.LG_CODELANGUE.ToString(), Objet.CL_CONTACT.ToString(), Objet.CL_CODECLIENT.ToString(), Objet.TYPEOPERATION.ToString()));
