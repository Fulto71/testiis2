...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsVille : IwsVille
    {
        ...
        //MODIFICATION
        public string pvgModifier(clsVille Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsVille clsVille = new ZenithWebServeur.BOJ.clsVille();
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsVille clsVilleDTO in Objet)
                //{

                clsVille.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                clsVille.VL_REFERENCE = Objet.VL_REFERENCE.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsVilleWSBLL.pvgModifier(clsDonnee, clsVille, clsObjetEnvoi));
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsVille Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.SO_CODESOCIETE, Objet.PY_CODEPAYS };
                ...
                //clsObjetRetour.SetValue(true, clsVilleWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsVilleWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
        ...
        //COMBO VILLE
        public string pvgChargerDansDataSetPourCombo(clsVille Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
