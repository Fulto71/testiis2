...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMembreresponsable" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMembreresponsable.svc ou wsMembreresponsable.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMembreresponsable : IwsMembreresponsable
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsMembreresponsable Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMembreresponsable clsMembreresponsable = new ZenithWebServeur.BOJ.clsMembreresponsable();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMembreresponsable clsMembreresponsableDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "MR_CODEMEMBRERESPO", "MR_LIBELLE" };
                ...
                //DataSet = clsMembreresponsableWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
