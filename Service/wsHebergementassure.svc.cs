...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsHebergementassure" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsHebergementassure.svc ou wsHebergementassure.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsHebergementassure : IwsHebergementassure
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsHebergementassure Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsHebergementassure clsHebergementassure = new ZenithWebServeur.BOJ.clsHebergementassure();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsHebergementassure clsHebergementassureDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "HA_CODEHEBERGEMENT", "HA_LIBELLE" };
                ...
                //DataSet = clsHebergementassureWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
