...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsBanqueagence : IwsBanqueagence
    {
        ...
        //AJOUT
        public string pvgAjouter(clsBanqueagence Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsBanqueagence clsBanqueagence = new ZenithWebServeur.BOJ.clsBanqueagence();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsBanqueagence clsBanqueagenceDTO in Objet)
                //{
                
                clsBanqueagence.BQ_CODEBANQUE = int.Parse(Objet.BQ_CODEBANQUE.ToString());
                clsBanqueagence.AB_LIBELLE = Objet.AB_LIBELLE.ToString();
                clsBanqueagence.AB_ADRESSEGEOGRAPHIQUE = Objet.AB_ADRESSEGEOGRAPHIQUE.ToString();
                clsBanqueagence.AB_BOITEPOSTALE = Objet.AB_BOITEPOSTALE.ToString();
                clsBanqueagence.AB_TELEPHONE = Objet.AB_TELEPHONE.ToString();
                clsBanqueagence.AB_FAX = Objet.AB_FAX.ToString();
                clsBanqueagence.AB_EMAIL = Objet.AB_EMAIL.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsBanqueagenceWSBLL.pvgAjouter(clsDonnee, clsBanqueagence, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsBanqueagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.BQ_CODEBANQUE, Objet.AB_CODEAGENCEBANCAIRE };
                ...
                clsObjetRetour.SetValue(true, clsBanqueagenceWSBLL.pvgModifier(clsDonnee, clsBanqueagence, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsBanqueagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsBanqueagenceWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsBanqueagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.BQ_CODEBANQUE };
                ...
                //clsObjetRetour.SetValue(true, clsBanqueagenceWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsBanqueagence Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
