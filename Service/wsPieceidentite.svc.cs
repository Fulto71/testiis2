...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsPieceidentite" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsPieceidentite.svc ou wsPieceidentite.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsPieceidentite : IwsPieceidentite
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsPieceidentiteWSBLL clsPieceidentiteWSBLL = new clsPieceidentiteWSBLL();
        ...
        public string pvgChargerDansDataSetPourCombo(clsPieceidentite Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsPieceidentite clsPieceidentite = new ZenithWebServeur.BOJ.clsPieceidentite();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsPieceidentite clsPieceidentiteDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                DataSet = clsPieceidentiteWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
