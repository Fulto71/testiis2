...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMiccreditamortissement" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMiccreditamortissement.svc ou wsMiccreditamortissement.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMiccreditamortissement : IwsMiccreditamortissement
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMiccreditamortissementWSBLL clsMiccreditamortissementWSBLL = new clsMiccreditamortissementWSBLL();
        ...
        //AJOUT
        public string pvgAjouter(clsMiccreditamortissement Objet)
        {
            ...
            try
            {
                ...
                //clsMiccreditamortissement.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                ...
                //clsMiccreditamortissement.PV_RAISONSOCIAL = Objet.PV_RAISONSOCIAL.ToString();
                //clsMiccreditamortissement.PV_BOITEPOSTAL = Objet.PV_BOITEPOSTAL.ToString();
                //clsMiccreditamortissement.PV_ADRESSEGEOGRAPHIQUE = Objet.PV_ADRESSEGEOGRAPHIQUE.ToString();
                //clsMiccreditamortissement.PV_TELEPHONE = Objet.PV_TELEPHONE.ToString();
                //clsMiccreditamortissement.PV_FAX = Objet.PV_FAX.ToString();
                //clsMiccreditamortissement.PV_EMAIL = Objet.PV_EMAIL.ToString();
                //clsMiccreditamortissement.PV_POINTVENTECODE = Objet.PV_POINTVENTECODE.ToString();
                //clsMiccreditamortissement.PV_NUMEROCOMPTE = Objet.PV_NUMEROCOMPTE.ToString();
                //clsMiccreditamortissement.PV_REFERENCE = Objet.PV_REFERENCE.ToString();
                //clsMiccreditamortissement.PV_DATECREATION = DateTime.Parse(Objet.PV_DATECREATION.ToString());
                //clsMiccreditamortissement.PV_ACTIF = Objet.PV_ACTIF.ToString();
                //clsMiccreditamortissement.OP_GERANT = Objet.OP_GERANT.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgAjouter(clsDonnee, clsMiccreditamortissement, clsObjetEnvoi));
        ...
        //AJOUT
        public string pvgAjouterListe(List<clsMiccreditamortissement> Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                foreach (ZenithWebServeur.DTO.clsMiccreditamortissement clsMiccreditamortissementDTO in Objet)
                {
                    clsObjetEnvoi.OE_PARAM = new string[] { clsMiccreditamortissementDTO.AG_CODEAGENCE, clsMiccreditamortissementDTO.CR_CODECREDIT };
                    ZenithWebServeur.BOJ.clsMiccreditamortissement clsMiccreditamortissement = new ZenithWebServeur.BOJ.clsMiccreditamortissement();
                ...
                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgAjouterListe(clsDonnee, clsMiccreditamortissements, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        public string pvgChargerDansDataSetTableauAmortissement(clsMiccreditamortissement Objet)
        {
            ...
            try
            {
                ...
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] {
                    Objet.AG_CODEAGENCE, Objet.CL_CODECLIENT, Objet.CL_NOMCLIENT, Objet.CL_PRENOMCLIENT, Objet.CR_CODECREDIT
                };
                ...
                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgChargerDansDataSetTableauAmortissement(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //AJOUT
        public string pvgChargerDansDataSetTableauAmortissement1(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;
                DataSet = clsMiccreditamortissementWSBLL.pvgChargerDansDataSetTableauAmortissement(clsDonnee, clsObjetEnvoi);
        ...
        public string pvgChargerDansDataSetTableauAmortissementok(clsMiccreditamortissement Objet)
        {
            ...
            try
            {
                ...
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    ...
                    clsMiccreditWSBLL clsMiccreditWSBLL = new clsMiccreditWSBLL();
                    clsMiccreditfraisWSBLL clsMiccreditfraisWSBLL = new clsMiccreditfraisWSBLL();
                    DataSet1 = clsObjetRetour.OR_DATASET;

                    clsObjetEnvoi.OE_PARAM = new string[] {
                   Objet.AG_CODEAGENCE, Objet.CL_CODECLIENT, Objet.CL_NOMCLIENT, Objet.CL_PRENOMCLIENT, Objet.EX_DATEDEBUTPREMIEREXERCICE, Objet.DATEJOURNEE};
                    DataSet2 = clsMiccreditWSBLL.pvgChargerDansDataSetCompteCredit(clsDonnee, clsObjetEnvoi);

                    clsObjetEnvoi.OE_PARAM = new string[] {
                    Objet.AG_CODEAGENCE, Objet.CL_CODECLIENT, Objet.CL_NOMCLIENT, Objet.CL_PRENOMCLIENT, Objet.CR_CODECREDIT, Objet.DATEJOURNEE};
                    DataSet3 = clsMiccreditfraisWSBLL.pvgChargerDansDataSetReglementFrais(clsDonnee, clsObjetEnvoi);



                    string reportPath = "~/Etats/";// + Objet.ET_DOSSIER;
                    string reportFileName = "TableauAmortissement.rpt";// PP_VALEURREC1;// Objet.ET_NOMETAT;// "YTDVarianceCrossTab.rpt";
                    string exportFilename = "";
                    string URL_ETAT = "";


                    string[] vppFichierSousEtat = new string[] { "CreditCompte.rpt", "CreditFrais.rpt" };
                    DataSet[] vppDataSetSousEtat = new DataSet[] { DataSet2, DataSet3 };

                    URL_ETAT = Stock.WCF.Utilities.CrystalReport.RenderReport(reportPath, reportFileName, exportFilename, DataSet1, vppFichierSousEtat, vppDataSetSousEtat, Objet.vappNomFormule, Objet.vappValeurFormule);
        ...
        //AJOUT
        public string pvgChargerDansDataSetTableauAmortissement_second(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
        ...
        //AJOUT
        public string pvgChargerDansDataSetTableauAmortissementTiers(clsMiccreditamortissement Objet)
        {
            DataSet DataSet1 = new DataSet();
            DataSet DataSet2 = new DataSet();
            DataSet DataSet3 = new DataSet();
            ...
            try
            {
                ...
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] {
                   Objet.AG_CODEAGENCE, Objet.TI_NUMEROTIERS, Objet.TI_NOMTIERS, Objet.CR_CODECREDIT
                };
                ...
                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgChargerDansDataSetTableauAmortissementTiers(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    ...
                    clsObjetEnvoi.OE_PARAM = new string[] {
                   Objet.AG_CODEAGENCE, Objet.TI_NUMEROTIERS, Objet.TI_NOMTIERS,"PRETSINSTITUTION", Objet.EX_DATEDEBUTPREMIEREXERCICE, Objet.DATEJOURNEE};
                    DataSet2 = clsMiccreditWSBLL.pvgChargerDansDataSetCompteCredit(clsDonnee, clsObjetEnvoi);

                    clsObjetEnvoi.OE_PARAM = new string[] {
                   Objet.AG_CODEAGENCE, Objet.TI_NUMEROTIERS, Objet.TI_NOMTIERS,"PRETSINSTITUTION", Objet.CR_CODECREDIT, Objet.DATEJOURNEE};
                    DataSet3 = clsMiccreditfraisWSBLL.pvgChargerDansDataSetReglementFrais(clsDonnee, clsObjetEnvoi);
        ...
        //AJOUT
        public string pvgRemoursementCreditRadie(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsMiccreditamortissement.PV_CODEPOINTVENTE = Objet.PV_CODEPOINTVENTE.ToString();
                clsMiccreditamortissement.TS_CODETYPESCHEMACOMPTABLE = Objet.TS_CODETYPESCHEMACOMPTABLE.ToString();
                clsMiccreditamortissement.PD_CODETYPEPRODUIT = Objet.PD_CODETYPEPRODUIT.ToString();
                clsMiccreditamortissement.AT_DATEECHEANCE = DateTime.Parse(Objet.AT_DATEECHEANCE.ToString());
                clsMiccreditamortissement.DATEJOURNEECOMPTABILISATION = DateTime.Parse(Objet.DATEJOURNEECOMPTABILISATION.ToString());
                clsMiccreditamortissement.CR_TYPEREMBOURSEMENT = Objet.CR_TYPEREMBOURSEMENT.ToString();
                clsMiccreditamortissement.AT_MONTANT = Double.Parse(Objet.AT_MONTANT.ToString());
        ...
        //MODIFICATION
        public string pvgModifier(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgModifier(clsDonnee, clsMiccreditamortissement, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMiccreditamortissementWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                DataSet = clsMiccreditamortissementWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
        ...
        //LISTE
        public string pvgChargerDansDataSetEcheanceRestant(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.AG_CODEAGENCE, Objet.CR_CODECREDIT, Objet.DATEJOURNEE, Objet.CR_TYPEREMBOURSEMENT };
                ...
                DataSet = clsMiccreditamortissementWSBLL.pvgChargerDansDataSetEcheanceRestant(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
        ...
        //LISTE
        public string pvgChargerDansDataSetEcheanceRestantRegenerationTableauAmortissement(clsMiccreditamortissement Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.AG_CODEAGENCE, Objet.CR_CODECREDIT, Objet.DATEJOURNEE };
                ...
                DataSet = clsMiccreditamortissementWSBLL.pvgChargerDansDataSetEcheanceRestantRegenerationTableauAmortissement(clsDonnee, clsObjetEnvoi);
                if (DataSet.Tables[0].Rows.Count > 0)
                {
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
                    DataSet.Tables[0].Columns.Add(new DataColumn("SL_RESULTAT", typeof(string)));
