...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsRepasfourni" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsRepasfourni.svc ou wsRepasfourni.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsRepasfourni : IwsRepasfourni
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsRepasfourni Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsRepasfourni clsRepasfourni = new ZenithWebServeur.BOJ.clsRepasfourni();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsRepasfourni clsRepasfourniDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "RF_CODEREPAS", "RF_LIBELLE" };
                ...
                //DataSet = clsRepasfourniWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
