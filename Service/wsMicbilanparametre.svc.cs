...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMicbilanparametre" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMicbilanparametre.svc ou wsMicbilanparametre.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMicbilanparametre : IwsMicbilanparametre
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMicbilanparametreWSBLL clsMicbilanparametreWSBLL = new clsMicbilanparametreWSBLL();
        ...
        //AJOUT
        public string pvgAjouter(clsMicbilanparametre Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMicbilanparametre clsMicbilanparametre = new ZenithWebServeur.BOJ.clsMicbilanparametre();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMicbilanparametre clsMicbilanparametreDTO in Objet)
                //{
                ...
                clsObjetRetour.SetValue(true, clsMicbilanparametreWSBLL.pvgAjouter(clsDonnee, clsMicbilanparametre, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsMicbilanparametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicbilanparametreWSBLL.pvgModifier(clsDonnee, clsMicbilanparametre, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsMicbilanparametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsMicbilanparametreWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsMicbilanparametre Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                //clsObjetRetour.SetValue(true, clsMicbilanparametreWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMicbilanparametreWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
