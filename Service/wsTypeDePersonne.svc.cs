...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsTypeDePersonne" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsTypeDePersonne.svc ou wsTypeDePersonne.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsTypeDePersonne : IwsTypeDePersonne
    {
        ...
        //LISTE
        public string pvgChargerDansDataSetPourCombo(clsTypeDePersonne Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsTypeDePersonne clsTypeDePersonne = new ZenithWebServeur.BOJ.clsTypeDePersonne();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsTypeDePersonne clsTypeDePersonneDTO in Objet)
                //{

                string[] vlpChamp1 = new string[] { "TP_CODETYPEDEPERSONNE", "TP_LIBELLE" };
                ...
                //DataSet = clsTypeDePersonneWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
