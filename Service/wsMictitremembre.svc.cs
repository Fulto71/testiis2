...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsMictitremembre" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsMictitremembre.svc ou wsMictitremembre.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsMictitremembre : IwsMictitremembre
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsMictitremembreWSBLL clsMictitremembreWSBLL = new clsMictitremembreWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsMictitremembre Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsMictitremembre clsMictitremembre = new ZenithWebServeur.BOJ.clsMictitremembre();
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsMictitremembre clsMictitremembreDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsMictitremembreWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsMictitremembreWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
