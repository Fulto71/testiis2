...
namespace ZenithWebServeur.WCF
{
    ...
    public partial class wsCommune : IwsCommune
    {
        ...
        //AJOUT
        public string pvgAjouter(clsCommune Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsCommune clsCommune = new ZenithWebServeur.BOJ.clsCommune();
          ...
          //DataSet = TestChampObligatoireInsert(Objet);
            ...
            try
            {
                ...
                //foreach (ZenithWebServeur.DTO.clsCommune clsCommuneDTO in Objet)
                //{
                
                clsCommune.VL_CODEVILLE = Objet.VL_CODEVILLE.ToString();
                clsCommune.CO_LIBELLE = Objet.CO_LIBELLE.ToString();
                clsCommune.CO_DESCRIPTION = Objet.CO_DESCRIPTION.ToString();

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                clsObjetRetour.SetValue(true, clsCommuneWSBLL.pvgAjouter(clsDonnee, clsCommune, clsObjetEnvoi));
        ...
        //MODIFICATION
        public string pvgModifier(clsCommune Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
           ...
           //DataSet = TestChampObligatoireUpdate(Objet);
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.VL_CODEVILLE, Objet.CO_CODECOMMUNE };
                ...
                clsObjetRetour.SetValue(true, clsCommuneWSBLL.pvgModifier(clsDonnee, clsCommune, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //SUPPRESSION
        public string pvgSupprimer(clsCommune Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsCommuneWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi));
                if (clsObjetRetour.OR_BOOLEEN)
                {
                    DataSet = new DataSet();
                    DataRow dr = dt.NewRow();
        ...
        //LISTE
        public string pvgChargerDansDataSet(clsCommune Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
            ...
            try
            {
                //clsDonnee.pvgConnectionBase();
                clsDonnee.pvgDemarrerTransaction();
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.VL_CODEVILLE };
                ...
                //clsObjetRetour.SetValue(true, clsCommuneWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsCommuneWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi);
        ...
        //COMBO COMMUNE
        public string pvgChargerDansDataSetPourCombo(clsCommune Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
