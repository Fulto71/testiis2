...
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsSituationmatrimoniale" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsSituationmatrimoniale.svc ou wsSituationmatrimoniale.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsSituationmatrimoniale : IwsSituationmatrimoniale
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        private clsSituationmatrimonialeWSBLL clsSituationmatrimonialeWSBLL = new clsSituationmatrimonialeWSBLL();
        ...
        //COMBO
        public string pvgChargerDansDataSetPourCombo(clsSituationmatrimoniale Objet)
        {
            ...
            ZenithWebServeur.BOJ.clsSituationmatrimoniale clsSituationmatrimoniale = new ZenithWebServeur.BOJ.clsSituationmatrimoniale();
            ...
            try
            {
                ...
                clsObjetEnvoi.OE_PARAM = new string[] { Objet.SX_CODESEXE };

                //foreach (ZenithWebServeur.DTO.clsSituationmatrimoniale clsSituationmatrimonialeDTO in Objet)
                //{

                clsObjetEnvoi.OE_A = Objet.clsObjetEnvoi.OE_A;
                clsObjetEnvoi.OE_Y = Objet.clsObjetEnvoi.OE_Y;

                //clsObjetRetour.SetValue(true, clsSituationmatrimonialeWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
                DataSet = clsSituationmatrimonialeWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi);
